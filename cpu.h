...
static void snoop_downgrade_peers(CPU *cpu, uint8_t core_id, uint64_t address,
                                  L3SetMeta *l3_set_meta,
                                  L3SetData *l3_set_data, uint8_t l3_set_way,
                                  bool *shared)
{
...
inline void cpu_read(CPU *cpu, uint8_t core_id, uint64_t address, uint8_t *data,
...
inline void cpu_write(CPU *cpu, uint8_t core_id, uint64_t address,
                      uint8_t *data, uint8_t data_size, uint8_t *memory)
{
    Core *core = &cpu->cores[core_id];
    uint16_t l1_set_index = l1_to_index(address);
...
inline void cpu_fetch(CPU *cpu, uint8_t core_id, uint64_t address,
                      uint8_t *data, uint8_t data_size, uint8_t *memory)
{
    Core *core = &cpu->cores[core_id];
    uint16_t l1_set_index = l1_to_index(address);
